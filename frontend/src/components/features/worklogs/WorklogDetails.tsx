...
const WorklogDetails: React.FC<WorklogDetailsProps> = ({
  ...
  // TODO validateWorklogCode() käynnistyy aina kun code muuttuu, mutta vanha timeout ei peruunnu
  // Voi aiheuttaa useita rinnakkaisia kutsuja jos käyttäjä kirjoittaa nopeasti
  // -> cleanup clearTimeoutin kanssa
  // Esim:
  /*useEffect(() => {
  ...
  }, [code, modify, firstCode, setCourseExists]);*/
  // Tämä estää päällekkäiset kutsut
