...
import AdminNewUser from '../../views/main/admin/users/AdminNewUser.tsx';
import AdminProfile from '../../views/main/admin/AdminProfile.tsx';
import AdminCoursesRoutes from './AdminCourseRoutes.tsx';
import AdminDashBoardRoutes from './AdminDashBoardRoutes.tsx';
import AdminLecturesRoutes from './AdminLectureRoutes.tsx';
import AdminSettingsRoutes from './AdminSettingsRoutes.tsx';
import AdminUserRoutes from './AdminUserRoutes.tsx';
import AdminWorkLogRoutes from './AdminWorkLogRoutes.tsx';
import AdminOtherDashboards from '../../views/main/admin/dashboard/AdminOtherDashboards.tsx';
import AdminPracticumRoutes from './AdminPracticumRoutes.tsx';
import AdminFeedback from '../../views/main/admin/dashboard/AdminFeedback.tsx';
/**
...
const AdminRoutes = () => {
  ...
  return (
    <Routes>
      ...
      <Route path='practicum/*' element={<AdminPracticumRoutes />} />
      ...
      <Route path='other-dashboards' element={<AdminOtherDashboards />} />
