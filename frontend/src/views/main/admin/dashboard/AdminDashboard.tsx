 ...
 * AdminDashboard View
 *
 * Renders the admin dashboard layout with navigation links and nested content via <Outlet />.
 * Handles active state styling for navigation and internationalized titles.
 *
 * @returns JSX.Element
 */
...
const AdminDashboard = () => {
  ...
  // TODO: Siirto omaan tiedostoon, esim. config/navigation/adminNavItems.ts (kansio pitää luoda)
  const navItems = [
