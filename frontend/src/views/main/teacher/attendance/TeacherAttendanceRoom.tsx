...
import Attendees from '../../../../components/features/courses/attendance/Attendees.tsx';
import CourseStudents from '../../../../components/features/courses/attendance/CourseStudents.tsx';
import AttendanceSettings from '../../../../components/features/courses/attendance/AttendanceSettings.tsx';
...
import IPWarningTooltip, {
  IPTrackingData,
} from '../../../../components/ui/IPWarningTooltip';
    ...
    if (!socket) {
      ...
      newSocket.on('manualStudentInsertSuccess', (receivedLectureId) => {
        if (receivedLectureId === lectureid) {
          ...
          console.log("Successfully added student manually");
        }
      });
      ...
      newSocket.on('manualStudentInsertError', (receivedLectureId) => {
        if (receivedLectureId === lectureid) {
          ...
          console.log("Failed to add student manually");
        }
      });
